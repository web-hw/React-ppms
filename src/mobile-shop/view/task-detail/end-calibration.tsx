...
interface IPropsEndCalibration {}

interface IStateEndCalibration {}

export default class EndCalibration extends React.PureComponent<
  IPropsEndCalibration,
  IStateEndCalibration
> {
  render() {
    return (
      <div className={`${style.endCalibration} wp100 hp100 pr pt50 bsb oh fs0`}>
        <Header
          right={
            <span
              onClick={() => Toast.info('此需求已结束定标')}
