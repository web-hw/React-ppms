  ...
  function u(e) {
    ...
    ;(this.editor = e),
      ...
      (this.droplist = new d(this, {
        ...
        type: 'list',
        list: [
          { $elem: o('<h1>H1</h1>'), value: '<h1>' },
          { $elem: o('<h2>H2</h2>'), value: '<h2>' },
          { $elem: o('<h3>H3</h3>'), value: '<h3>' },
          { $elem: o('<h4>H4</h4>'), value: '<h4>' },
          { $elem: o('<h5>H5</h5>'), value: '<h5>' },
    ...
    ;(this.editor = e),
      ...
      (this.droplist = new d(this, {
        ...
        list: [
          ...
          { $elem: o('<span>normal</span>'), value: '3' },
          {
  ...
  function F(e, t, n) {
    ...
    if (
      (null == i
        ...
        : ((o = i.getData('text/plain')), (A = i.getData('text/html'))),
      !A && o && (A = '<p>' + a(o) + '</p>'),
      A)
    ) {
      var r = A.split('</html>')
    ...
    return (
      (e.childNodes() || []).forEach(function(e) {
        ...
        if ((3 === i && ((n = e.textContent), (n = a(n))), 1 === i)) {
          ...
          for (
            var A = [], r = e.attributes || {}, c = r.length || 0, s = 0;
            s < c;
            s++
          ) {
            var l = r[s]
      ...
      return (
        ...
        this.forEach(function(e) {
          i.forEach(function(i) {
            if (i) {
              if ((G.push({ elem: e, type: i, fn: n }), !t))
        ...
        if (n) {
          ...
          if ('TD' === i || 'TH' === i) {
            ...
            A.forEach(function(t, i) {
              if (t === n[0])
                return (e.td = { index: i, elem: t, length: r }), !1
            })
            var c = o.parent(),
              a = c.children(),
              s = a.length
            return (
              a.forEach(function(t, n) {
                if (t === o[0])
                  return (e.tr = { index: n, elem: t, length: s }), !1
              }),
              e
            )
          }
